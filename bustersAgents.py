...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # gets most likely ghost pos for all ghosts
        ghostPositions = []
        ...
        for ghostPos in ghostPositions:
            tClose[ghostPos] = self.distancer.getDistance(pacmanPosition, ghostPos)
        closest = min(tClose, key=tClose.get)

        # find action to get closer to ghost
        aDict = dict()
        for a in legal:
            newPos = Actions.getSuccessor(pacmanPosition, a)
            aDict[a] = self.distancer.getDistance(closest, newPos)
